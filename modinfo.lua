...
[[功能：
1.右键单击地图一点，自动走向该位置
停止方法：方向键，攻击键，鼠标点击；地图中：空格键
2.在没有按下组合键时右键双击地图上一点，进行原本的地图右键操作，如灵魂跳跃
3.延迟补偿是否开启，右键寻路都能生效
4.小地图也能直接右键寻路，但是不能跳跃
5.寻路自动绕路功能(已经开启，在路径跟随过程中自动生效修正路径)
...
or
[[1.Click a point on the map or Minimap Mod with right button and automatically walk to target
2.DoubleClick a point on the map with right button and it will soulhop when you pick wortox (without Ctrl/Shift/Alt key down)
3.Now It can work whether turning on and off "Lag compensation"
...
{	
	...
	options = {{description = CH and "开启" or "Enable",data = true},{description = CH and "关闭" or "Disable",data = false}},
	default = true,
},
{	
