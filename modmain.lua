...
AddPlayerPostInit(function(player)
	...
	player.components.ngl_pathfollower:SetPathfinder(player.components.ngl_pathfinder)
	if pathfinder ~= player.components.ngl_pathfinder then
		player.components.ngl_pathfollower:SetLuaPathfinder(player.components.ngl_astarpathfinder)
	end
	-- deprecated , i have set use C side pathfinder only when pathcaps.allowocean = true in ngl_pathfollower
	...
	--	player.components.ngl_pathfollower.lua_pathfinder = nil
